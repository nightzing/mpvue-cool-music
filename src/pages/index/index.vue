<template>
    <div class="content">
        ...
        <div class="songList">
            ...
            <div class="songitem">
                <div v-for="(item,index) in songitem" :key="item.id" v-if="index<=5" class="songWidth">
                    <div class="songImg">
        ...
        <div class="songList" style="margin-top:20rpx">
            ...
            <div class="Single">
                <div v-for="(item,index) in Single" :key="item.id" v-if="index<=4" class="SingleWidth" @click="musicUrl(item.id)">
                    ...
                    <i style="background:url(data:image/svg+xml;base64,); background-size:40rpx 40rpx; width:40rpx;height:40rpx;"></i>
                </div>
            </div>
        </div>
        <div class="songList">
